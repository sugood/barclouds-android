package com.barclouds.views.filesChooser;
...
import com.barclouds.views.filesChooser.FileChooserAdapter.FileInfo;
import com.barclouds.views.ui.IoActivity;
...
public class FileChooserActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mSdcardRootPath = Environment.getExternalStorageDirectory().getAbsolutePath();//获取SD卡根目录
	...
	private AdapterView.OnItemClickListener mItemClickListener = new OnItemClickListener() {
		public void onItemClick(AdapterView<?> adapterView, View view, int position,
			...
			else if(fileInfo.isXLSFile()){  //是xls文件 ， 则将该路径通知给调用者
			    Intent intent = new Intent();
			    intent.putExtra(IoActivity.EXTRA_FILE_CHOOSER , fileInfo.getFilePath());
