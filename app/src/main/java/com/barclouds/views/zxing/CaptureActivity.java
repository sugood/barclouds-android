package com.barclouds.views.zxing;
...
import com.barclouds.views.zxing.camera.CameraManager;
import com.barclouds.views.zxing.common.BitmapUtils;
import com.barclouds.views.zxing.decode.BitmapDecoder;
import com.barclouds.views.zxing.decode.CaptureActivityHandler;
import com.barclouds.views.zxing.view.ViewfinderView;
...
public final class CaptureActivity extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("BarcloudsDebug","CaptureActivity onCreate");
		hasSurface = false;
	...
	public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        mIntent.putExtra("str1", ResultParser.parseResult(rawResult).toString());
        // 设置结果，并进行传送
