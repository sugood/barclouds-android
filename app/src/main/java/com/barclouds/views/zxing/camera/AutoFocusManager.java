...
package com.barclouds.views.zxing.camera;
...
import com.barclouds.views.zxing.config.Config;
import com.barclouds.views.zxing.common.Runnable;
...
final class AutoFocusManager implements Camera.AutoFocusCallback {
	...
	private final class AutoFocusTask extends AsyncTask<Object, Object, Object> {
		...
		protected Object doInBackground(Object... voids) {
			...
			synchronized (com.barclouds.views.zxing.camera.AutoFocusManager.this) {
				if (active) {
					start();
				}
			}
