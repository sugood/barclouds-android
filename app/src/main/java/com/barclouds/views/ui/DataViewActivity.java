 ...
 * 带滑动表头与固定列的ListView
 */
public class DataViewActivity extends BaseActivity implements
         OnClickListener{
...
//		setContentView(R.layout.activity_hlistview);
        Log.d("BarcloudsDebug", "HListViewActivity.onCreate");
		//init();
	}
...
//                Log.d("BarCloudsDebug:", "is_divPage=" + is_divPage);
                if (is_divPage && scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE) {
                    if (pageNo <= totalPage){
                        ...
                        footerView.setVisibility(View.GONE);
                        Toast.makeText(DataViewActivity.this, "没有更多数据...", Toast.LENGTH_SHORT).show();
                    }
                }
            }
            /**
...
//                Log.d("BarCloudsDebug:","visibleItemCount="+visibleItemCount);
    ...
    public void loading() {
        ...
        NetRequestConstant.requestUrl = NetUrlConstant.DATAPAGE;
...
//                        Log.d("BarcloudsDebug","showhtml"+(String) res);
                        PageBean<Data> page = gson.fromJson((String) res,
                                new TypeToken<PageBean<Data>>() {
                                }.getType());
...
//                        Log.d("BarcloudsDebug:","datassize="+datas.size());
                         ...
                         */
                        if(totalPage==0)
                            Toast.makeText(DataViewActivity.this, "没有数据...", Toast.LENGTH_SHORT).show();
                        ...
                        //刷新数据总数
                        appContext.setDataSum((long)totalCount);
                        //防止pageNo大于总页数
                        pageNo++;
                        //隐藏提示
                        footerView.setVisibility(View.GONE);
    ...
    private  void initListview() {
        ...
        datasend = new ArrayList<Data>();

        mAdapter = new ScrollAdapter(DataViewActivity.this, datas, R.layout.common_item_hlistview//R.layout.item
                , cols
...
//            Log.d("BarcloudsDebug:","size="+datas.size());
	...
	protected View.OnClickListener clickListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			Toast.makeText(DataViewActivity.this, "点击了:" + ((TextView) v).getText(), Toast.LENGTH_SHORT).show();
		}
	};
...
//        Log.d("BarcloudsDebug","information:DiaryActivity.onClick-start");
        switch (v.getId()) {
            ...
            case R.id.imagebutton_search:
                Intent intent0 = new Intent(DataViewActivity.this,
            ...
            case R.id.imagebutton_refresh:
                ...
                dialog =new CustomProgressDialog(DataViewActivity.this, "正在刷新...",R.anim.frame);
                dialog.show();
                initListview();
                break;
            case R.id.imagebutton_delete:
                Dialog dialogChoose=new AlertDialog.Builder(DataViewActivity.this)
                .setTitle("删除全部数据")
                ...
                .setPositiveButton("确认", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialogChoose, int which) {
                        dialog =new CustomProgressDialog(DataViewActivity.this, "正在删除...",R.anim.frame);
                        dialog.show();
                        jsondelete(0);
                    }
                })
...
//        Log.d("BarcloudsDebug","information:DiaryActivity.onClick-end");
    ...
    private void jsondelete(int id){
        ...
        // post请求
        nrc.setType(HttpRequestType.POST);
        NetRequestConstant.requestUrl = NetUrlConstant.DATADELETE;
        NetRequestConstant.context = this;
        Map<String, Object> map = new HashMap<String, Object>();
            ...
            public void preccess(Object res, boolean flag) {
                if (res != null) {
                    try {
                        ...
                        if (success.equals("1")) {
                            Toast.makeText(DataViewActivity.this, "删除数据成功！",
                                    Toast.LENGTH_LONG).show();
                            //刷新显示
                            initListview();
                        }else {
                            Toast.makeText(DataViewActivity.this, "删除数据失败",
                                    Toast.LENGTH_LONG).show();
                        }
                        //关闭动态提示
                        if(dialog!=null)
